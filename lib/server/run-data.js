...
export function buildRouteFreeFixture({ task, identity, now = new Date() }) {
  const generatedRoute = {
    ...
    pointName: '无固定路线',
    pointList: [
      { longitude: 118.82, latitude: 31.94 },
      { longitude: 118.824, latitude: 31.94 },
      { longitude: 118.824, latitude: 31.943 },
      { longitude: 118.82, latitude: 31.943 },
    ],
  };
  const fixture = buildRunFixture({ task, route: generatedRoute, identity, now });
