...
var x78=_v()
_(o68,x78)
if(_oz(z,1,e,s,gg)){x78.wxVkey=1
var f98=_mz(z,'van-cell',['customClass',2,'label',1,'title',2,'value',3,'valueClass',4],[],e,s,gg)
_(x78,f98)
}
else{x78.wxVkey=2
var c08=_n('slot')
_rz(z,c08,'name',7,e,s,gg)
_(x78,c08)
}
var hA9=_n('view')
...
var o88=_v()
_(o68,o88)
if(_oz(z,9,e,s,gg)){o88.wxVkey=1
var cC9=_n('view')
_rz(z,cC9,'class',10,e,s,gg)
var oD9=_n('slot')
_rz(z,oD9,'name',11,e,s,gg)
_(cC9,oD9)
_(o88,cC9)
}
x78.wxXCkey=1
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vant-weapp/panel/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vant-weapp/common/index.wxss"],".",[1],"van-panel{background:#fff}\n.",[1],"van-panel__header-value{color:#f44}\n.",[1],"van-panel__footer{padding:10px 15px}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vant-weapp/panel/index.wxss"});
}