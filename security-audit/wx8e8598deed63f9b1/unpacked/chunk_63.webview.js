...
var x=['./miniprogram/miniprogram_npm/vantNew/rate/index.wxml'];d_[x[0]]={}
var m0=function(e,s,r,gg){
var z=gz$gwx_XC_68_1()
var t7OB=_mz(z,'view',['bind:touchmove',0,'class',1],[],e,s,gg)
var e8OB=_v()
_(t7OB,e8OB)
var b9OB=function(xAPB,o0OB,oBPB,gg){
var cDPB=_mz(z,'view',['class',4,'style',1],[],xAPB,o0OB,gg)
var oFPB=_mz(z,'van-icon',['bind:click',6,'class',1,'color',2,'customClass',3,'data-score',4,'name',5,'style',6],[],xAPB,o0OB,gg)
_(cDPB,oFPB)
var hEPB=_v()
_(cDPB,hEPB)
if(_oz(z,13,xAPB,o0OB,gg)){hEPB.wxVkey=1
var cGPB=_mz(z,'van-icon',['bind:click',14,'class',1,'color',2,'customClass',3,'data-score',4,'name',5,'style',6],[],xAPB,o0OB,gg)
_(hEPB,cGPB)
}
hEPB.wxXCkey=1
hEPB.wxXCkey=3
...
e8OB.wxXCkey=4
_2z(z,2,b9OB,e,s,gg,e8OB,'item','index','index')
_(r,t7OB)
return r
}
