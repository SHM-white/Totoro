...
var x=['./miniprogram/miniprogram_npm/vantNew/switch/index.wxml'];d_[x[0]]={}
var m0=function(e,s,r,gg){
var z=gz$gwx_XC_79_1()
var xQUB=_mz(z,'view',['bind:tap',0,'class',1,'style',1],[],e,s,gg)
var oRUB=_n('view')
_rz(z,oRUB,'class',3,e,s,gg)
var fSUB=_v()
_(oRUB,fSUB)
if(_oz(z,4,e,s,gg)){fSUB.wxVkey=1
var cTUB=_mz(z,'van-loading',['color',5,'customClass',1],[],e,s,gg)
_(fSUB,cTUB)
}
fSUB.wxXCkey=1
fSUB.wxXCkey=3
