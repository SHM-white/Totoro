...
var cSS=_mz(z,'van-icon',['class',22,'classPrefix',1,'color',2,'customClass',3,'dot',4,'info',5,'infoClass',6,'name',7,'size',8],[],e,s,gg)
_(oRS,cSS)
}
else{oRS.wxVkey=2
var oTS=_n('slot')
_rz(z,oTS,'name',31,e,s,gg)
_(oRS,oTS)
}
oRS.wxXCkey=1
oRS.wxXCkey=3
...
return root;
	...
	;__wxRoute = "miniprogram/miniprogram_npm/vantNew/goods-action-icon/index";__wxRouteBegin = true;__wxAppCurrentFile__="miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.js";define("miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var i=require("../common/component"),n=require("../mixins/button"),o=require("../mixins/link");(0,i.VantComponent)({classes:["icon-class","text-class","info-class"],mixins:[o.link,n.button],props:{text:String,dot:Boolean,info:String,icon:String,size:String,color:String,classPrefix:{type:String,value:"van-icon"},disabled:Boolean,loading:Boolean},methods:{onClick:function(i){this.$emit("click",i.detail),this.jumpLink()}}});
},{isPage:false,isComponent:true,currentFile:'miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.js'});require("miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.js");