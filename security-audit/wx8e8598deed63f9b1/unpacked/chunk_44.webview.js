...
var bUHB=_mz(z,'van-picker',['activeClass',0,'bind:cancel',1,'bind:change',1,'bind:confirm',2,'cancelButtonText',3,'class',4,'columnClass',5,'columns',6,'confirmButtonText',7,'itemHeight',8,'loading',9,'showToolbar',10,'title',11,'toolbarClass',12,'valueKey',13,'visibleItemCount',14],[],e,s,gg)
_(r,bUHB)
return r
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vantNew/area/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vantNew/common/index.wxss"],],undefined,{path:"./miniprogram/miniprogram_npm/vantNew/area/index.wxss"});
}