...
var oTZB=_mz(z,'view',['bind:tap',0,'class',1,'hoverClass',1,'hoverStayTime',2],[],e,s,gg)
var fUZB=_n('view')
_rz(z,fUZB,'class',4,e,s,gg)
var cVZB=_v()
_(fUZB,cVZB)
if(_oz(z,5,e,s,gg)){cVZB.wxVkey=1
var hWZB=_mz(z,'van-info',['customStyle',6,'info',1],[],e,s,gg)
_(cVZB,hWZB)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vant-weapp/badge/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vant-weapp/common/index.wxss"],".",[1],"van-badge{background-color:#f8f8f8;border-left:3px solid transparent;box-sizing:border-box;color:#7d7e80;display:block;font-size:14px;line-height:1.4;overflow:hidden;padding:20px 12px 20px 9px;-webkit-user-select:none;user-select:none;word-break:break-all}\n.",[1],"van-badge--hover{background-color:#f2f3f5}\n.",[1],"van-badge:after{border-bottom-width:1px}\n.",[1],"van-badge--active{border-color:#f44;color:#333;font-weight:700}\n.",[1],"van-badge--active:after{border-right-width:1px}\n.",[1],"van-badge--active,.",[1],"van-badge--active.",[1],"van-badge--hover{background-color:#fff}\n.",[1],"van-badge__text{position:relative}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vant-weapp/badge/index.wxss"});
}