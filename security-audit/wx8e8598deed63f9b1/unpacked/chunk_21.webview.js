...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vant-weapp/goods-action/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vant-weapp/common/index.wxss"],".",[1],"van-goods-action{background-color:#fff;bottom:0;display:-webkit-flex;display:flex;left:0;position:fixed;right:0}\n.",[1],"van-goods-action--safe{padding-bottom:34px}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vant-weapp/goods-action/index.wxss"});
}