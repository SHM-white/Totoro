...
var c5MB=_mz(z,'view',['class',0,'style',1],[],e,s,gg)
var o6MB=_mz(z,'view',['class',2,'style',1],[],e,s,gg)
var l7MB=_v()
_(o6MB,l7MB)
if(_oz(z,4,e,s,gg)){l7MB.wxVkey=1
var a8MB=_n('slot')
_(l7MB,a8MB)
}
else{l7MB.wxVkey=2
