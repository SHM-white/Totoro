...
var x=['./miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxml'];d_[x[0]]={}
...
var oXMB=_v()
_(bWMB,oXMB)
if(_oz(z,21,e,s,gg)){oXMB.wxVkey=1
var xYMB=_mz(z,'van-icon',['class',22,'classPrefix',1,'color',2,'customClass',3,'dot',4,'info',5,'infoClass',6,'name',7,'size',8],[],e,s,gg)
_(oXMB,xYMB)
}
else{oXMB.wxVkey=2
var oZMB=_n('view')
var f1MB=_n('slot')
_rz(z,f1MB,'name',31,e,s,gg)
_(oZMB,f1MB)
_(oXMB,oZMB)
}
var c2MB=_n('text')
_rz(z,c2MB,'class',32,e,s,gg)
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_59();	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxml'] = [$gwx_XC_59, './miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxml'];else __wxAppCode__['miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxml'] = $gwx_XC_59( './miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vantNew/common/index.wxss"],".",[1],"van-goods-action-icon{border:none!important;color:var(--goods-action-icon-text-color,#646566)!important;display:-webkit-flex!important;display:flex!important;-webkit-flex-direction:column;flex-direction:column;font-size:var(--goods-action-icon-font-size,10px)!important;height:var(--goods-action-icon-height,50px)!important;-webkit-justify-content:center!important;justify-content:center!important;line-height:1!important;min-width:var(--goods-action-icon-width,48px)}\n.",[1],"van-goods-action-icon__icon{color:var(--goods-action-icon-color,#323233);display:-webkit-flex;display:flex;font-size:var(--goods-action-icon-size,18px);margin:0 auto 5px}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vantNew/goods-action-icon/index.wxss"});
}