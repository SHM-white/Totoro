...
var cPRB=_v()
_(r,cPRB)
if(_oz(z,0,e,s,gg)){cPRB.wxVkey=1
var hQRB=_n('view')
_rz(z,hQRB,'class',1,e,s,gg)
var oRRB=_v()
_(hQRB,oRRB)
if(_oz(z,2,e,s,gg)){oRRB.wxVkey=1
var cSRB=_mz(z,'view',['class',3,'style',1],[],e,s,gg)
_(oRRB,cSRB)
}
var oTRB=_n('view')
...
var lURB=_v()
_(oTRB,lURB)
if(_oz(z,6,e,s,gg)){lURB.wxVkey=1
var aVRB=_mz(z,'view',['class',7,'style',1],[],e,s,gg)
_(lURB,aVRB)
}
var tWRB=_v()
_(oTRB,tWRB)
var eXRB=function(oZRB,bYRB,x1RB,gg){
var f3RB=_mz(z,'view',['class',12,'style',1],[],oZRB,bYRB,gg)
_(x1RB,f3RB)
return x1RB
}
tWRB.wxXCkey=2
_2z(z,10,eXRB,e,s,gg,tWRB,'item','index','index')
lURB.wxXCkey=1
_(hQRB,oTRB)
oRRB.wxXCkey=1
_(cPRB,hQRB)
