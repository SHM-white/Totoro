...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vantNew/row/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vantNew/common/index.wxss"],".",[1],"van-row:after{clear:both;content:\x22\x22;display:table}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vantNew/row/index.wxss"});
}