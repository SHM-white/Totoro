...
var x=['./miniprogram/miniprogram_npm/vantNew/checkbox/index.wxml'];d_[x[0]]={}
...
var fQQ=_mz(z,'view',['bindtap',2,'class',1],[],e,s,gg)
var cRQ=_n('slot')
_(fQQ,cRQ)
_(xOQ,fQQ)
}
var hSQ=_mz(z,'view',['bindtap',4,'class',1],[],e,s,gg)
var oTQ=_v()
_(hSQ,oTQ)
if(_oz(z,6,e,s,gg)){oTQ.wxVkey=1
var cUQ=_n('slot')
_rz(z,cUQ,'name',7,e,s,gg)
_(oTQ,cUQ)
}
else{oTQ.wxVkey=2
var oVQ=_mz(z,'van-icon',['class',8,'customClass',1,'customStyle',2,'name',3,'size',4,'style',5],[],e,s,gg)
_(oTQ,oVQ)
}
oTQ.wxXCkey=1
oTQ.wxXCkey=3
...
var lWQ=_mz(z,'view',['bindtap',15,'class',1],[],e,s,gg)
var aXQ=_n('slot')
_(lWQ,aXQ)
_(oPQ,lWQ)
}
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_51();	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram/miniprogram_npm/vantNew/checkbox/index.wxml'] = [$gwx_XC_51, './miniprogram/miniprogram_npm/vantNew/checkbox/index.wxml'];else __wxAppCode__['miniprogram/miniprogram_npm/vantNew/checkbox/index.wxml'] = $gwx_XC_51( './miniprogram/miniprogram_npm/vantNew/checkbox/index.wxml' );
	;__wxRoute = "miniprogram/miniprogram_npm/vantNew/checkbox/index";__wxRouteBegin = true;__wxAppCurrentFile__="miniprogram/miniprogram_npm/vantNew/checkbox/index.js";define("miniprogram/miniprogram_npm/vantNew/checkbox/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";var e=require("../common/relation");function a(e,a){e.$emit("input",a),e.$emit("change",a)}(0,require("../common/component").VantComponent)({field:!0,relation:(0,e.useParent)("checkbox-group"),classes:["icon-class","label-class"],props:{value:Boolean,disabled:Boolean,useIconSlot:Boolean,checkedColor:String,labelPosition:{type:String,value:"right"},labelDisabled:Boolean,shape:{type:String,value:"round"},iconSize:{type:null,value:20}},data:{parentDisabled:!1,direction:"vertical"},methods:{emitChange:function(e){this.parent?this.setParentValue(this.parent,e):a(this,e)},toggle:function(){var e=this.data,a=e.parentDisabled,t=e.disabled,i=e.value;t||a||this.emitChange(!i)},onClickLabel:function(){var e=this.data,a=e.labelDisabled,t=e.parentDisabled,i=e.disabled,n=e.value;i||a||t||this.emitChange(!n)},setParentValue:function(e,t){var i=e.data.value.slice(),n=this.data.name,l=e.data.max;if(t){if(l&&i.length>=l)return;-1===i.indexOf(n)&&(i.push(n),a(e,i))}else{var o=i.indexOf(n);-1!==o&&(i.splice(o,1),a(e,i))}}}});
},{isPage:false,isComponent:true,currentFile:'miniprogram/miniprogram_npm/vantNew/checkbox/index.js'});require("miniprogram/miniprogram_npm/vantNew/checkbox/index.js");