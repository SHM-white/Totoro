...
var c8UB=_mz(z,'view',['class',0,'style',1],[],e,s,gg)
var h9UB=_n('slot')
_(c8UB,h9UB)
_(r,c8UB)
var f7UB=_v()
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vantNew/tabbar/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vantNew/common/index.wxss"],".",[1],"van-tabbar{background-color:var(--tabbar-background-color,#fff);box-sizing:initial;display:-webkit-flex;display:flex;height:var(--tabbar-height,50px);width:100%}\n.",[1],"van-tabbar--fixed{bottom:0;left:0;position:fixed}\n.",[1],"van-tabbar--safe{padding-bottom:env(safe-area-inset-bottom)}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vantNew/tabbar/index.wxss"});
}