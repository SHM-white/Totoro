...
var x=['./miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxml'];d_[x[0]]={}
var m0=function(e,s,r,gg){
var z=gz$gwx_XC_80_1()
var oVUB=_mz(z,'view',['bindtap',0,'class',1,'style',1],[],e,s,gg)
var cWUB=_n('view')
_rz(z,cWUB,'class',3,e,s,gg)
var oXUB=_v()
_(cWUB,oXUB)
if(_oz(z,4,e,s,gg)){oXUB.wxVkey=1
var lYUB=_mz(z,'van-icon',['classPrefix',5,'customClass',1,'name',2],[],e,s,gg)
_(oXUB,lYUB)
}
else{oXUB.wxVkey=2
var aZUB=_v()
_(oXUB,aZUB)
if(_oz(z,8,e,s,gg)){aZUB.wxVkey=1
var t1UB=_n('slot')
_rz(z,t1UB,'name',9,e,s,gg)
_(aZUB,t1UB)
}
else{aZUB.wxVkey=2
var e2UB=_n('slot')
_rz(z,e2UB,'name',10,e,s,gg)
_(aZUB,e2UB)
}
aZUB.wxXCkey=1
}
var b3UB=_mz(z,'van-info',['customClass',11,'dot',1,'info',2],[],e,s,gg)
_(cWUB,b3UB)
oXUB.wxXCkey=1
oXUB.wxXCkey=3
_(oVUB,cWUB)
...
}(__g.a,__g.b,__g.c,__g.d,__g.e,__g.f,__g.g,__g.h,__g.i,__g.j,__g.k,__g.l,__g.m,__g.n,__g.o,__g.p,__g.q,__g.r,__g.s,__g.t,__g.u,__g.v,__g.w,__g.x,__g.y,__g.z,__g.A,__g.B,__g.C,__g.D,__g.E,__g.F,__g.G,__g.H,__g.I,__g.J,__g.K,__g.L,__g.M,__g.N,__g.O,__g.P,__g.Q,__g.R,__g.S,__g.T,__g.U,__g.V,__g.W,__g.X,__g.Y,__g.Z,__g.aa);if(__vd_version_info__.delayedGwx||false)$gwx_XC_80();	if (__vd_version_info__.delayedGwx) __wxAppCode__['miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxml'] = [$gwx_XC_80, './miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxml'];else __wxAppCode__['miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxml'] = $gwx_XC_80( './miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxml' );
	
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vantNew/common/index.wxss"],".",[1],"van-tabbar-item{-webkit-align-items:center;align-items:center;color:var(--tabbar-item-text-color,#646566);display:-webkit-flex;display:flex;-webkit-flex-direction:column;flex-direction:column;font-size:var(--tabbar-item-font-size,12px);height:100%;-webkit-justify-content:center;justify-content:center;line-height:var(--tabbar-item-line-height,1)}\n.",[1],"van-tabbar-item__icon{font-size:var(--tabbar-item-icon-size,22px);margin-bottom:var(--tabbar-item-margin-bottom,4px);position:relative}\n.",[1],"van-tabbar-item__icon__inner{display:block;min-width:1em}\n.",[1],"van-tabbar-item--active{color:var(--tabbar-item-active-color,#1989fa)}\n.",[1],"van-tabbar-item__info{margin-top:2px}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vantNew/tabbar-item/index.wxss"});
}