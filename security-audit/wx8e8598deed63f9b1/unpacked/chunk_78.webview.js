...
Z([3,'margin-xl bg-white padding-xl radius shadow-lg'])
Z([3,'text-center margin-bottom text-lg  text-grey'])
Z([3,'关于我们'])
Z([3,'text-content'])
Z([3,'感谢您的使用与支持!'])
...
var l9YB=_oz(z,2,e,s,gg)
_(o8YB,l9YB)
_(c7YB,o8YB)
var a0YB=_n('view')
_rz(z,a0YB,'class',3,e,s,gg)
var tAZB=_n('view')
var eBZB=_oz(z,4,e,s,gg)
_(tAZB,eBZB)
_(a0YB,tAZB)
_(c7YB,a0YB)
_(r,c7YB)
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/aboutus/index.wxss']=setCssToHead([[2,"./colorui/animation.wxss"],],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/aboutus/index.wxss:1:69)",{path:"./pages/aboutus/index.wxss"});
}