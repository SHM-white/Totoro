...
var x=['./miniprogram/miniprogram_npm/vantNew/index-bar/index.wxml'];d_[x[0]]={}
...
var xCNB=_v()
_(oBNB,xCNB)
if(_oz(z,1,e,s,gg)){xCNB.wxVkey=1
var fENB=_mz(z,'view',['catch:tap',2,'catch:touchcancel',1,'catch:touchend',2,'catch:touchmove',3,'class',4],[],e,s,gg)
var cFNB=_v()
_(fENB,cFNB)
var hGNB=function(cINB,oHNB,oJNB,gg){
var aLNB=_mz(z,'view',['class',9,'data-index',1,'style',2],[],cINB,oHNB,gg)
var tMNB=_oz(z,12,cINB,oHNB,gg)
_(aLNB,tMNB)
_(oJNB,aLNB)
return oJNB
}
cFNB.wxXCkey=2
_2z(z,7,hGNB,e,s,gg,cFNB,'item','index','index')
_(xCNB,fENB)
}
xCNB.wxXCkey=1
_(r,oBNB)
