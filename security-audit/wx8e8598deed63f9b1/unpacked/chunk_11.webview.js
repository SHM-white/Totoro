...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vant-weapp/cell-group/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vant-weapp/common/index.wxss"],".",[1],"van-cell-group__title{color:#999;font-size:14px;line-height:16px;padding:15px 15px 5px}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vant-weapp/cell-group/index.wxss"});
}