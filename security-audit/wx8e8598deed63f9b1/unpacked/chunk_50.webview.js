...
var tALB=_mz(z,'van-cell',['bind:click',1,'border',1,'class',2,'clickable',3,'customClass',4,'hoverClass',5,'icon',6,'isLink',7,'label',8,'rightIconClass',9,'size',10,'title',11,'titleClass',12,'value',13],[],e,s,gg)
var eBLB=_mz(z,'slot',['name',15,'slot',1],[],e,s,gg)
_(tALB,eBLB)
var bCLB=_mz(z,'slot',['name',17,'slot',1],[],e,s,gg)
_(tALB,bCLB)
var oDLB=_n('slot')
_rz(z,oDLB,'name',19,e,s,gg)
_(tALB,oDLB)
var xELB=_mz(z,'slot',['name',20,'slot',1],[],e,s,gg)
_(tALB,xELB)
_(a0KB,tALB)
var oFLB=_mz(z,'view',['animation',22,'class',1,'style',2],[],e,s,gg)
var fGLB=_n('view')
