...
var oBOB=_v()
_(cAOB,oBOB)
if(_oz(z,1,e,s,gg)){oBOB.wxVkey=1
var lCOB=_mz(z,'van-cell',['customClass',2,'label',1,'title',2,'value',3,'valueClass',4],[],e,s,gg)
_(oBOB,lCOB)
}
else{oBOB.wxVkey=2
var aDOB=_n('slot')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vantNew/panel/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vantNew/common/index.wxss"],".",[1],"van-panel{background:var(--panel-background-color,#fff)}\n.",[1],"van-panel__header-value{color:var(--panel-header-value-color,#ee0a24)}\n.",[1],"van-panel__footer{padding:var(--panel-footer-padding,8px 16px)}\n.",[1],"van-panel__footer:empty{display:none}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vantNew/panel/index.wxss"});
}