...
var l18=_mz(z,'van-transition',['customClass',0,'customStyle',1,'name',1,'show',2],[],e,s,gg)
var a28=_v()
_(l18,a28)
if(_oz(z,4,e,s,gg)){a28.wxVkey=1
var t38=_mz(z,'view',['class',5,'style',1],[],e,s,gg)
_(a28,t38)
}
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['miniprogram/miniprogram_npm/vant-weapp/notify/index.wxss']=setCssToHead([[2,"./miniprogram/miniprogram_npm/vant-weapp/common/index.wxss"],".",[1],"van-notify{box-sizing:border-box;font-size:14px;line-height:20px;padding:6px 15px;position:fixed;text-align:center;top:0;width:100%;word-break:break-all}\n.",[1],"van-notify__safe-top{height:44px}\n",],undefined,{path:"./miniprogram/miniprogram_npm/vant-weapp/notify/index.wxss"});
}