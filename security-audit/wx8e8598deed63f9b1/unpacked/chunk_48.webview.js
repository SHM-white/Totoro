...
var b7JB=_v()
_(e6JB,b7JB)
if(_oz(z,1,e,s,gg)){b7JB.wxVkey=1
var x9JB=_mz(z,'view',['bindtap',2,'class',1],[],e,s,gg)
var o0JB=_n('slot')
_(x9JB,o0JB)
_(b7JB,x9JB)
}
var fAKB=_mz(z,'view',['bindtap',4,'class',1],[],e,s,gg)
var cBKB=_v()
_(fAKB,cBKB)
if(_oz(z,6,e,s,gg)){cBKB.wxVkey=1
var hCKB=_n('slot')
_rz(z,hCKB,'name',7,e,s,gg)
_(cBKB,hCKB)
}
else{cBKB.wxVkey=2
var oDKB=_mz(z,'van-icon',['class',8,'customClass',1,'customStyle',2,'name',3,'size',4,'style',5],[],e,s,gg)
_(cBKB,oDKB)
}
cBKB.wxXCkey=1
cBKB.wxXCkey=3
...
var o8JB=_v()
_(e6JB,o8JB)
if(_oz(z,14,e,s,gg)){o8JB.wxVkey=1
var cEKB=_mz(z,'view',['bindtap',15,'class',1],[],e,s,gg)
var oFKB=_n('slot')
_(cEKB,oFKB)
_(o8JB,cEKB)
}
