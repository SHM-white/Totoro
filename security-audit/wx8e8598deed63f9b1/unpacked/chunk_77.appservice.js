...
var aPY=_mz(z,'van-button',['bindtap',0,'openType',1],[],e,s,gg)
_(r,aPY)
return r
}
...
return root;
	...
	;__wxRoute = "pages/aaa/index";__wxRouteBegin = true;__wxAppCurrentFile__="pages/aaa/index.js";define("pages/aaa/index.js",function(require,module,exports,window,document,frames,self,location,navigator,localStorage,history,Caches,screen,alert,confirm,prompt,XMLHttpRequest,WebSocket,Reporter,webkit,WeixinJSCore){
"use strict";
},{isPage:true,isComponent:true,currentFile:'pages/aaa/index.js'});require("pages/aaa/index.js");