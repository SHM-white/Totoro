...
var fI5B=_mz(z,'web-view',['binderror',1,'bindload',1,'bindmessage',2,'src',3],[],e,s,gg)
_(oH5B,fI5B)
}
else{oH5B.wxVkey=2
var cJ5B=_mz(z,'view',['class',5,'style',1],[],e,s,gg)
var hK5B=_n('text')
...
var noCss=typeof __vd_version_info__!=='undefined'&&__vd_version_info__.noCss===true;if(!noCss){__wxAppCode__['pages/fitnessH5/index.wxss']=setCssToHead(["body{background-color:#f2f2f7}\n",],"Some selectors are not allowed in component wxss, including tag name selectors, ID selectors, and attribute selectors.(./pages/fitnessH5/index.wxss:1:1)",{path:"./pages/fitnessH5/index.wxss"});
}